# 🐍 Snake Game - Complete Code Walkthrough (Line by Line A-Z)

This document explains every line of code in `snake_game.py` in detail, from start to finish.
...
- **Result:** High score file saved in same folder as snake_game.py (not outside)
- **Example:** `C:\...\snake-game\snake_game.highscore`
